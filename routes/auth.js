...
const { signinValidator, signupValidator, verifyEmail, verifyUser, recoverPasswordValidator } = require('../validators/authValidator')
...
router.post('/signup', signupValidator, validate, authController.signup)
    ...
    .post('/change-password', isAuth, authController.changePassword)
